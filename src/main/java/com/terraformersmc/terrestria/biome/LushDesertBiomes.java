...
public class LushDesertBiomes {
	public static Biome create(Registerable<Biome> entries, boolean oasis) {
	...
	private static GenerationSettings createGenerationSettings(Registerable<Biome> entries, boolean oasis) {
