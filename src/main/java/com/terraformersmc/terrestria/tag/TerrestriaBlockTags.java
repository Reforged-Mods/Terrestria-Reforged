...
public final class TerrestriaBlockTags {
	...
	public static final TagKey<Block> DIRT = TerrestriaBlockTags.of(Identifier.of("forge", "dirt"));
	public static final TagKey<Block> GRAVEL = TerrestriaBlockTags.of(Identifier.of("forge", "gravel"));
	public static final TagKey<Block> PLANKS_THAT_BURN = TerrestriaBlockTags.of(Identifier.of("forge", "planks_that_burn"));
	public static final TagKey<Block> SAND = TerrestriaBlockTags.of(Identifier.of("forge", "sand"));
